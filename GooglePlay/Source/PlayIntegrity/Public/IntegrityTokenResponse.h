...
#include "IntegrityTokenResponse.generated.h"
 ...
 */
DECLARE_DYNAMIC_DELEGATE_TwoParams(FShowDialogOperationCompletedDelegate,
	EIntegrityErrorCode, Error, EIntegrityDialogResponseCode, Response);
...
class PLAYINTEGRITY_API UIntegrityTokenResponse : public UObject
{
	GENERATED_BODY()
...
public:
	...
	/**
	 * Initializes the UIntegrityTokenResponse object and sets the native token
	 * response object.
	 *
	 * @param InNativeTokenResponse The native token response object.
	 */
	void Initialize(IntegrityTokenResponse* InNativeTokenResponse);
